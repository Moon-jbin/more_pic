...
class ProductDetailScreen extends HookConsumerWidget {
  ...
  final ProductModel? productExtra;
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final int originalPrice = (product.price * 1.7).toInt();
    final int memberPrice = product.price;
    ...
    return CustomScaffold(
      ...
      // ⭐️ 핵심: bodyBuilder 대신 sliverBuilder 사용 및 배열 반환
