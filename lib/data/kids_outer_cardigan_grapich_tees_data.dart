...
///```
/// Kids / OUTER / 가디건 / Grapich Tees 데이터
///```
final List<ProductItem> kidsOuterCardiganGrapichTeesData = [
  // [1 페이지용]
  const ProductItem(
      name: '레이커 드로우7부팬츠 (1-1)',
      option: '<진청>',
      size: '*XS~XXL*',
  ...
  const ProductItem(
      ...
      salePrice: '16,000원'),
  const ProductItem(
      name: '레이커 마일넛프릴숏팬츠 (1-3)',
      option: '<크림/퍼플>',
      size: '*XS~XXL*',
      originalPrice: '17,600원',
      salePrice: '17,600원'),
  const ProductItem(
      name: '레이커 하트자수점프슈트 (1-4)',
      option: '<블루진>',
      size: '*XS~L*',
  ...
  const ProductItem(
      ...
      salePrice: '26,000원'),
  const ProductItem(
      name: '크림베어 서스펜더팬츠 (2-7)',
      option: '<크림>',
      size: '*S~M*',
      originalPrice: '31,000원',
      salePrice: '28,900원'),
  const ProductItem(
      name: '바람슝슝 메쉬 나시 세트 (2-8)',
      option: '<옐로우>',
      size: '*XS~XL*',
  ...
  const ProductItem(
      ...
      salePrice: '19,000원'),
  const ProductItem(
      name: '네이처 슬러브 반팔티 (3-7)',
      option: '<아이보리/그린>',
      size: '*XS~XL*',
      originalPrice: '13,500원',
      salePrice: '13,500원'),
  const ProductItem(
      name: '배기핏 밴딩 코튼팬츠 (3-8)',
      option: '<차콜>',
      size: '*S~XXL*',
      originalPrice: '22,000원',
      salePrice: '22,000원'),
